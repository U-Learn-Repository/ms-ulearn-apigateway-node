export const endpoint = {
    ...
    quizzes: {
        questions: 'http://54.159.72.1:7777/api/v1/questions/',
        question: 'http://54.159.72.1:7777/api/v1/question/',
        questionById: 'http://54.159.72.1:7777/api/v1/question/',
        answer: 'http://54.159.72.1:7777/api/v1/answer/',
        qualification: 'http://54.159.72.1:7777/api/v1/qualification/'
    },
    users: {
